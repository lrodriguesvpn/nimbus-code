---
name: "nc-designer"
description: "Nimbus Interface Designer — Aplica julgamento estético de UI/UX de alto padrão (evita clichês de 'AI slop'), audita interfaces existentes e gera diretrizes de design distintivas para o produto."
argument-hint: "[screen/component description, or audit|critique|polish|harden <target>]"
compatibility: "Requires spec-kit project structure with .specify/ directory"
metadata:
  author: "nimbus-code"
  role: "NC-Designer"
  source: "docs/comparisons/impeccable-and-claude-design-vs-nimbus-code.md"
---
