---
name: "nc-bug-assess"
description: "Nimbus Bug Triage — Avalia um relato de bug (texto colado, URL ou Issue do GHE) contra o código atual, localiza a causa suspeita e propõe remediação."
compatibility: "Requires spec-kit project structure with .specify/ directory and the 'bug' SpecKit extension installed"
metadata:
  author: "nimbus-code"
  role: "NC-Bug-Assess"
