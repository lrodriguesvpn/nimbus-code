...
description: Cria ou atualiza, no backlog externo configurado (JIRA ou Azure DevOps),
  o item correspondente à spec/tasks da feature ativa.
argument-hint: "Optional feature slug or backlog item reference"
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: extension:nimbus-code-backlog-sync
---

# Nimbus Code Backlog Sync Sync Skill
