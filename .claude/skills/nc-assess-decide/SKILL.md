...
description: "Nimbus Assessment Decider — Aplica o gate formal de viabilidade (Go / Needs Clarification / Kill) e realiza o handoff para o ciclo de especificação formal (.specify/assessments/<slug>/decision.md)."
argument-hint: "[assessment slug to evaluate]"
