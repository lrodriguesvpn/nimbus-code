...
| T042–T068 | [#450](https://venha-pra-nuvem.ghe.com/venha-pra-nuvem/nimbus-code-spec-kit-template/issues/450) (sub-issues a gerar via `/speckit-taskstoissues`) | User Story 4 (governança de PR e segurança de código) |
