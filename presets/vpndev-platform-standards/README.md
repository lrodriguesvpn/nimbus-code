# vpndev-platform-standards (preset)

## Propósito

Aplica os padrões de governança de **plataforma/cliente/ambiente** da VPN Dev
sobre os templates nativos do Spec Kit. É o par complementar do
[`vpndev-standards`](../vpndev-standards) — mas para um **tipo diferente de
repositório**:
...
projeto separado, usando `vpndev-standards`.
...
`vpndev-standards` — ambos podem evoluir em versões diferentes. Mudar seu
conteúdo é uma mudança de política organizacional e requer aprovação do time
responsável pelos padrões da VPN Dev antes de publicar uma nova versão.
...
criado depois que este preset **e** o `vpndev-standards` estiverem estáveis e
publicados.
