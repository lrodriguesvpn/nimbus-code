...
| **Bundle `nimbus-code-project-bundle`** ([nimbus-code-spec-kit-template](https://venha-pra-nuvem.ghe.com/venha-pra-nuvem/nimbus-code-spec-kit-template)) | `1.21.0` |
| — preset `nimbus-code-standards` | `1.21.0` |
